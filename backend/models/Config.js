...
const configSchema = new mongoose.Schema(
  {
    booking: {
        openDaysBefore: { type: Number, default: 3 },
        slotDurationHours: { type: Number, required: true, default: 1, min: 1, max: 24 },
        maxBookingsPerWeek: { type: Number, default: 2 },
        minBookingTimeBeforeHours: { type: Number, default: 2 },
    },
    cancellation: {
