...
const SystemStatusBanner = () => {
	...
	return (
		<div
			className={`${statusConfig.color} dark:bg-opacity-20 rounded-xl p-4 sm:p-5 mb-6 shadow-sm mt-4 border border-gray-100 dark:border-gray-800 transition-all hover:shadow-md`}
		>
			{/* Header Section */}
