...
// Shared markdown configuration could be extracted to a utility file,
// but kept here for strict file-separation requests.
const MARKDOWN_COMPONENTS = {
	h1: ({ node, ...props }) => (
		<h1 className='text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6'>{props.children}</h1>
	),
	h2: ({ node, ...props }) => (
	...
	return (
		...
		>
			...
			<div className='w-full max-w-4xl mt-10'>
				{isAdmin && <PageEditor slug='terms-of-service' onUpdate={fetchPageData} />}
							...
							<div className='pt-6 border-t border-gray-200 dark:border-gray-700'>
								<p className='text-sm text-gray-500 dark:text-gray-400'>
									...
									{pageData.lastUpdated
										? new Date(pageData.lastUpdated).toLocaleDateString(i18n.language, {
												year: 'numeric',
												month: 'long',
												day: 'numeric',
										  })
